...
namespace monolithic_pr2_planner {
    class RobotState {
        public:
            ...
            KDL::Frame getTargetObjectFrameRelBody(DiscObjectState targetState);
            ...
            static bool workspaceInterpolateSequential(const RobotState& start, const RobotState& end,
                                             std::vector<RobotState>* interp_steps);
